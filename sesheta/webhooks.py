...
def handle_prometheus_alert_webhook():  # pragma: no cover
    ...
    notify_channel(
        ...
        f"<b>Instance</b>: {payload['commonLabels']['instance']}\n"
        f"<b>Job</b>: {payload['commonLabels']['job']}\n"
        f"<b>Severity</b>: <font color='{alert_color}'>{payload['commonAnnotations']['severity']}</font>\n"
